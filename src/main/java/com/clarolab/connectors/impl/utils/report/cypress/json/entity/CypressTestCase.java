...
@Data
@Log
public class CypressTestCase extends AbstractTestCreator {
    ...
    private CypressTestCaseError err;
    private List<String> steps;

    @Builder
    private CypressTestCase(String title, double duration, String status, String screenshotURL, String videoURL, CypressTestCaseError err, List<String> steps) {
        this.title = title;
    ...
    public TestExecution getTest(CypressSuite cypressSuite, boolean isForDebug) {
        return TestExecution.builder()
                .testCase(getTestCase(this.title, cypressSuite.getUri(), isForDebug))
                .duration(this.getDuration())
                .suiteName(cypressSuite.getTitle())
                .status(this.getStatus())
                .errorDetails(this.err != null ? this.err.getMessage() : null)
                .errorStackTrace(this.err != null ? this.err.getStack() : null)
