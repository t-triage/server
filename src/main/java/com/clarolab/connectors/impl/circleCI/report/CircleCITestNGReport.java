...
@Data
@Builder
public class CircleCITestNGReport implements CircleCIReportType{
    ...
    public Report getReport(CircleCIProjectBuildArtifactElementEntity circleCIProjectBuildArtifactElementEntityWithReport, String applicationTestingEnvironmentVersion, HttpClient httpClient) throws ConnectorServiceException {
        ...
        return TestNGReport.builder().context(context).applicationTestingEnvironmentVersion(applicationTestingEnvironmentVersion).build().createReport(json, "This is a testNG report for CircleCI");
    }
