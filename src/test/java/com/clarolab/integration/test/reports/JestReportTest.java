...
import com.clarolab.connectors.impl.utils.report.builder.JestReportBuilder;
...
public class JestReportTest extends BaseReportTest {
    ...
    public void reportTest() {
        ...
        for (String file : jestFiles) {
            log.info("Testing jest file: " + file);
            String reportStr = super.getReportContentFromJson(super.getReport("jest", file));

            MainJest mainJest = JestReportBuilder.builder().build().getBuilder().create().fromJson(reportStr, MainJest.class);
            ...
            report.add(mainJest.getTests(true));
    ...
    @Test
    public void reportUtilKhorosTest() {
        String file = "reports/jest/jest1.json";
        log.info("Testing jest file: " + file);
        String content = super.getReportContentFromJson(super.getReport("jest", file));
        ...
        artifact.setFileName("jest-report.json");
