...
public class CircleFolderToTest extends BaseFunctionalTest {
    ...
    public void getExecutorsCleanContainer() {
        ...
        // Executor Validation
        Assert.assertEquals("Amount of executors in container", 5, executors.size());
    ...
    private void initializeProvider() {
        if (!initialized) {
            ...
            connector.setName("CircleCIClarolab");
