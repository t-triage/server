...
import static com.clarolab.util.Constants.CSV;
import static io.restassured.RestAssured.given;

public class ImportCSVReportAPITest extends BaseAPITest {
    ...
    public void importCSV () {
        ...
        String body = "{\"csvContent\": \"" + content+ "\", \"separator\": \"" + separator+ "\", \"format\": \"" + format + "\"}";

        ExtractableResponse<Response> answer = given()
                .body(body)
                .post(API_EXECUTOR_URI + CSV ).then().statusCode(HttpStatus.SC_OK)
                .extract();
